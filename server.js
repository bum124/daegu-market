...
app.post('/api/ai-recommend', async (req, res) => {
  try {
    ...
    4. 어떠한 경우에도 해당 제품의 '신품 가격'과 비슷하거나 넘어서는 가격을 제시해선 안 돼. (노트북 등 원래 고가의 전자기기는 절대적인 금액 상한선 없이, 철저히 신품가에서 감가상각된 중고가만 산정해.)

    반드시 "category", "minPrice", "maxPrice", "reason" 4개의 키를 가지는 순수 JSON 객체를 반환해.
    - reason에는 신품 예상가와 감가상각 이유를 포함해서 설득력 있게 적어줘. (예: "사진상 에디파이어 MR4 모델로 보이며 신품가는 약 6~7만 원 선입니다. 우퍼 쪽에 먼지 등 사용감이 뚜렷해 40% 이상 감가를 적용한 대학생 추천가입니다.")
